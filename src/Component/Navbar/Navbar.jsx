...
function Navbar() {
    ...
    //Checkscroll and change navbar background
    useEffect(() => {
        const handleScroll = () => {
    ...
    >
            <div className='text-white py-5 flex justify-between items-center'>
                ...
                <div className='text-white py-5 flex justify-between items-center'>
                    ...
                    <span className='text-white text-3xl '><b>Shivani</b></span>
                    <span className='text-[#8245ec]'>&gt;</span>
                ...
                <div className="hidden md:flex space-x-4">
                    <a 
                    href="https://github.com/Shivani332"
                    target="_blank"
                    ...
                    <a 
                    href="https://www.linkedin.com/in/shivani-4506922a8/"
                    target="_blank"
                    rel='noopener noreferrer'
                    className='text-gray-300 hover:text-[#8245ec]'>
                        <FaLinkedin size={24}/>
